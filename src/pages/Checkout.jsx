        ...
        <div className="lg:w-[70%]">
          ...
          <div className="">
            <div className="">
              ...
              <div className="">
                <button className=' border-[1px] border-[#262626] px-6 py-3 rounded-[4px] inline-block bg-[#262626] text-[#ffff] hover:bg-[#ffff] hover:text-[#262626] duration-300 mt-[10px]'>
                  <a className=' font-dm font-bold text-[14px]'>Buy Now</a>
                </button>
              </div>
              <ToastContainer />
